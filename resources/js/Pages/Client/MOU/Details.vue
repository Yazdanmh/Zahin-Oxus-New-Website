        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="team__details-info-wrap">
              <h2 class="title">{{ props.mou.title }}</h2>
              <span>{{ props.mou.parties_involved }}</span>
              <div class="sidebar__widget" style="max-width: 350px">
              ...
              <p v-html="props.mou.description"></p>
              <p>
                <strong>Start Date: </strong>{{ props.mou.start_date }} |
                <span v-if="props.mou.end_date"
                  ><strong>End Date: </strong>{{ props.mou.end_date }}</span
                >
                <br />
              </p>
            </div>
...
const nav = [
  ...
  { name: "MOUs", url: route("mous.index") },
  { name: props.mou.title, url: route("mous.index") },
];
</script>
