<template>
    ...
    <ClientLayout :setting="props.setting" :service="props.service_categories">
        <!-- Breadcrumb Section -->
        <Breadcrumb :title="'All Teams & Trainers'" :nav="nav" />
                    ...
                    <div class="col-lg-6">
                        <div class="section__content white-content mb-50">
                            <p>
                                ...
                                nothing hinders us, we are able to do what we
                                like best — a true source of pleasure..
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="team__item">
                            ...
                            <div class="team__content">
                                <h2 class="title">
                                    <Link
                                        :href="
                                            route('trainer.show', trainer.slug)
                                        "
                                        >{{ trainer.name }}</Link
                                    >
                                </h2>
...
const nav = [
    ...
    { name: "trainers", url: route("trainer.index") },
];
</script>
