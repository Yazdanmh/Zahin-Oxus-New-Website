            ...
            <aside class="services__sidebar">
              <div class="sidebar__widget">
                <div class="sidebar__contact">
                  <h4 class="title">Plan Your Academic Year with Confidence</h4>
                  <p>
                    Stay organized with our detailed academic calendar, ensuring
            ...
            <section class="team__details-area">
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-12">
                    <div class="sidebar__widget">
                      <h4 class="sidebar__widget-title">Academic Calendar</h4>
                      <div class="sidebar__brochure">
                        <p>
                          Download the latest academic calendar to stay updated
                          on key dates, including semester schedules, holidays,
...
const nav = [
  ...
  { name: "Academic Calendar", url: route("calendar.index") },
];
