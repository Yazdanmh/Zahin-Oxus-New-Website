<template>
    ...
    <section class="banner__area fix " style="padding-top:50px; padding-bottom:100px;">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-7">
            <div class="banner__content">
              ...
              <div v-if="props.hero.button" class="banner__btn" data-aos="fade-up" data-aos-delay="700">
                <Link :href="props.hero.link" class="tg-btn"
                  >{{ props.hero.button }}
                  <img
      ...
      <div class="banner__shape">
        <img
          src="/frontend/assets/img/banner/hero_shape02.svg"
          alt="shape"
          data-aos="fade-right"
          data-aos-delay="800"
        />
