<template>
    <!-- project-area -->
    <section class="project__area section-py-130 project__bg" data-background="/frontend/assets/img/bg/project_bg.jpg">
        <div class="container">
        ...
        <div class="swiper-container project-active fix">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" v-for="(project, index) in projects.data" :key="index">
