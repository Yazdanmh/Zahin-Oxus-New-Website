        ...
        <section class="project__area section-py-130">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="section__title mb-50 mb-md-30">
                            ...
                            <h2 class="title" v-if="props.type === 'upcoming'">
                                Explore Our Upcoming Training Opportunities
                            </h2>
                            <h2
                                class="title"
                                v-else-if="props.type === 'previous'"
                            >
                                Popular Trainings Offered Recently
                            </h2>
                        </div>
                    </div>
                ...
                <div
                    ...
                    "
                    class="text-center py-10 px-4  border-gray-300 rounded-xl bg-gray-50 dark:bg-gray-800 dark:border-gray-600"
                >
                   
                    <p
                        class=""
                    >
                        <template v-if="props.type === 'upcoming'">
                            We're preparing new training sessions—stay tuned for updates!
                        </template>
                        <template v-else-if="props.type === 'previous'">
                            It looks like there haven’t been any recent training
                            sessions. Stay tuned for future updates.
                        </template>
                        <template v-else>
                            We couldn’t find any training sessions right now.
                            Try adjusting your filters or explore other
                            categories.
                        </template>
                    </p>
                </div>
                ...
                <div class="pagination__wrap mt-40">
                    <ul class="list-wrap">
                        ...
                        >
                            <Link
                                :href="`${props.trainings.path}?page=${page}`"
                                >{{ page }}</Link
                            >
                        </li>
                    </ul>
