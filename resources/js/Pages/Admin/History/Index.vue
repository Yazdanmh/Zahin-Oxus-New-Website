          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form @submit.prevent="submit">
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <small v-if="errors.subtitle" class="text-danger">{{ errors.subtitle }}</small>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-3">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      <label for="progress_items" class="form-label">Progress Items (JSON)</label>
                      <textarea class="form-control" id="progress_items" rows="3" v-model="form.progress_items" placeholder='Example: {"Consulting": 75, "Investment": 90}'></textarea>
                      <small v-if="errors.progress_items" class="text-danger">{{ errors.progress_items }}</small>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img :src="imagePreviewOne || (props.history?.image_one ? '/storage/' + props.history.image_one : '/default-placeholder.jpg')" alt="Image One" class="d-block rounded" style="width: 300px; height: 100px; object-fit: cover" />
                        <div class="button-wrapper">
                          <label for="upload-one" class="btn btn-primary me-2 mb-4">
                            <span class="d-none d-sm-block">Upload Image</span>
                            <input type="file" id="upload-one" hidden accept="image/png, image/jpeg" @change="handleImageOneUpload" />
                          </label>
                          <p class="text-muted mb-0">
                            Allowed formats: JPG, PNG. Max size: 1MB.
                          </p>
                          <small v-if="errors.image_one" class="text-danger">{{ errors.image_one }}</small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img :src="imagePreviewTwo || (props.history?.image_two ? '/storage/' + props.history.image_two : '/default-placeholder.jpg')" alt="Image Two" class="d-block rounded" style="width: 300px; height: 100px; object-fit: cover" />
                        <div class="button-wrapper">
                          <label for="upload-two" class="btn btn-primary me-2 mb-4">
                            <span class="d-none d-sm-block">Upload Image</span>
                            <input type="file" id="upload-two" hidden accept="image/png, image/jpeg" @change="handleImageTwoUpload" />
                          </label>
                          <p class="text-muted mb-0">
                            Allowed formats: JPG, PNG. Max size: 1MB.
                          </p>
                          <small v-if="errors.image_two" class="text-danger">{{ errors.image_two }}</small>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <button type="submit" class="btn btn-primary mt-3">Update History</button>
              </form>
            </div>
          </div>
        </div>
