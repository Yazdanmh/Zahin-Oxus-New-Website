                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <small class="text-muted"
                                >Update role name and permissions</small
                            >
                        </div>
                        <div class="card-body">
...
// Main services with CRUD permissions
const services = [
    "site_data",
    "training",
    "events",
...
// System-level action-based permissions (non-CRUD)
const systemPermissions = [
    { label: "Take Backup", key: "system.backup" },
    { label: "Change User Password", key: "system.change_user_password" },
    { label: "View Logs", key: "system.view_logs" },
    { label: "Clear Cache", key: "system.clear_cache" },
];
