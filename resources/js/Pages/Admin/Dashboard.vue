                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          >
                            <div class="avatar flex-shrink-0">
                              <img
                                src="/backend/assets/img/icons/unicons/paypal.png"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          >
                            <div class="avatar flex-shrink-0">
                              <img
                                src="/backend/assets/img/icons/unicons/cc-primary.png"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                      ...
                      <div class="tab-content p-0">
                        ...
                        >
                          <div class="d-flex p-4 pt-3">
                            <div class="avatar flex-shrink-0 me-3">
                              <img
                                src="/backend/assets/img/icons/unicons/wallet.png"
                                alt="User"
                              />
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img
                              src="/backend/assets/img/icons/unicons/chart.png"
                              alt="User"
                              class="rounded"
                            />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img
                              src="/backend/assets/img/icons/unicons/cc-success.png"
                              alt="User"
                              class="rounded"
                            />
                          </div>
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-3">
                            <img
                              src="/backend/assets/img/icons/unicons/cc-warning.png"
                              alt="User"
                              class="rounded"
                            />
                          </div>
