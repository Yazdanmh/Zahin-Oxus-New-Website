<template>
              ...
              <div class="card-body">
                <form @submit.prevent="submit">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label for="happy_users" class="form-label">Happy Users</label>
                        <input
                          type="number"
                          class="form-control"
                          id="happy_users"
                    ...
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label for="case_complete" class="form-label">Case Complete</label>
                        <input
                          type="number"
                          class="form-control"
                          id="case_complete"
                    ...
                    <div class="col-md-3">
                      <div class="mb-3">
                        ...
                        />
                        <div v-if="errors.years_of_experience" class="text-danger mt-2">
                    ...
                    <div class="col-md-3">
                      <div class="mb-3">
                        ...
                        />
                        <div v-if="errors.professional_advisor" class="text-danger mt-2">
  ...
  const form = useForm({
    happy_users: props.counter.happy_users,
    case_complete: props.counter.case_complete,
    years_of_experience: props.counter.years_of_experience,
    professional_advisor: props.counter.professional_advisor,
  });
