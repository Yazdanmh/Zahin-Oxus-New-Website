                            ...
                            >
                                ...
                                <td v-if="hasPermission('training.edit') || hasPermission('training.delete') || hasPermission('training.view')">
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base bx bx-pencil icon-xs"
                                            ></i>
                                        </span>
                                    </Link>
                                    <span
                                    ...
                                    >
                                        <i
                                            class="icon-base bx bx-trash icon-xs"
                                        ></i>
                                    </span>
                                    <Link
                                        :href="
                                            route('training.show', training.id)
                                        "
                                    >
                                        <span
                                            class="badge bg-label-primary p-1_5 me-3 cursor-pointer mb-2"
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base bx bx-show icon-xs"
                                            ></i>
                                        </span>
                                    </Link>
                                </td>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            <li
                                class="page-item"
                                :class="{
                                    disabled: !props.trainings.prev_page_url,
                                }"
                            >
                                <a
                                    class="page-link"
                            ...
                            <li
                                class="page-item"
                                :class="{
                                    disabled: !props.trainings.next_page_url,
                                }"
                            >
                                <a
                                    class="page-link"
