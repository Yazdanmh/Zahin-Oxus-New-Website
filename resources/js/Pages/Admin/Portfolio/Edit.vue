  ...
  <AdminLayout :setting="props.setting" :user="props.user">
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Home /</span> Portfolio / Edit
      </h4>
      <div class="row">
        <div class="col-xl">
          <div class="card mb-4">
            ...
            >
              ...
              <small class="text-muted float-end"
                >Update Portfolio Details</small
              >
            </div>
            <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  >
                    <img
                      ...
                      :src="imagePreview || `/storage/${props.portfolio.image}`"
...
const form = useForm({
  ...
  date: props.portfolio.date,
  description: props.portfolio.description,
  category_id: props.portfolio.category_id || "",
  image: null,
  has_form: !!props.portfolio.has_form,
});

const errors = ref({});
const imagePreview = ref(
  props.portfolio.image ? `/storage/${props.portfolio.image}` : ""
);
...
const resetImage = () => {
  form.image = null;
  imagePreview.value = props.portfolio.image
    ? `/storage/${props.portfolio.image}`
    : "";
};
...
const submit = () => {
  ...
  form.put(route("portfolio.update", props.portfolio.id), {
    preserveScroll: true,
    onSuccess: () => toast.success("Portfolio Updated Successfully"),
    onError: (err) => {
