<template>
                ...
                <form @submit.prevent="submit">
                  ...
                  <div class="d-flex justify-content-end gap-3 mt-4">
                    <button type="submit" class="btn btn-primary">
                      <i class="bx bx-save"></i> Update Certificate
                    </button>
                  </div>
                </form>
              </div>
  ...
  const form = useForm({
    certificate_code: props.certificate.certificate_code || "",
  ...
  const submit = () => {
    form.put(route("certificate.update", props.certificate.id), {
      preserveScroll: true,
      onSuccess: () => {
        toast.success("Certificate Updated Successfully");
        errors.value = {}; // Reset errors if needed
      },
      onError: (err) => {
  ...
  onMounted(() => {
    // Initialize the form data with existing certificate values
    form.certificate_code = props.certificate.certificate_code;
    form.certificate_name = props.certificate.certificate_name;
    form.issue_date = props.certificate.issue_date;
    form.for_who = props.certificate.for_who;
    form.training_id = props.certificate.training_id;
  });
  </script>
