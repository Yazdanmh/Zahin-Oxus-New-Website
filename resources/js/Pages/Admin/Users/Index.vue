                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small class="text-muted"
                                >Manage users and their roles</small
                            >
                            <div
                                ...
                                <tbody>
                                    <tr v-for="user in users" :key="user.id">
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="bx bx-refresh icon-xs me-1"
                                                ></i>
                                                Reset
                                            </span>
                                        </td>
...
const confirmReset = (userId) => {
  Swal.fire({
    ...
    text: "This will reset the password to: Zahin@2022",
    icon: "question",
    showCancelButton: true,
    confirmButtonColor: "#3085d6",
    cancelButtonColor: "#d33",
    ...
    if (result.isConfirmed) {
      form.post(route('users.reset-password', userId), {
        onSuccess: () => {
