<template>
    ...
    <AdminLayout>
      <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
          <span class="text-muted fw-light">Home /</span> Testimonial / Edit
        </h4>
        <div class="row">
          <div class="col-xl">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">Edit the testimonial</small>
              </div>
              <div class="card-body">
                <form @submit.prevent="submit">
                  ...
                  <div class="d-flex justify-content-end gap-3 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                      <i class="bx bx-save"></i> Save Testimonial
                    </button>
                  </div>
                </form>
              </div>
  ...
  const errors = ref({});
  const imagePreview = ref('/storage/' + props.testimonial.image); // Assuming `image_url` holds the current image URL
  ...
  const resetImage = () => {
    form.image = null;
    imagePreview.value = '/storage/' + props.testimonial.image; // Reset to original image if reset
  };
  ...
  const submit = () => {
    ...
    form.post(route("testimonails.update", form.id), {
      preserveScroll: true,
      onSuccess: () => {
