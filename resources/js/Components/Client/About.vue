      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6 col-md-9">
          <div class="about__img-wrap">
            <div class="about__images">
              <img :src="'/storage/' + about.image_one" alt="Image One" style="width: 511px; height: 338px; object-fit: cover" />
              <img :src="'/storage/' + about.image_two" alt="Image Two" data-aos="fade-up" data-aos-delay="200" style="width: 357px; height: 228px; object-fit: cover" />
            </div>
            <!-- Experience Wrap -->
            <div class="experience__wrap" data-aos="fade-left" data-aos-delay="200">
              <h2 class="count">{{ counter.years_of_experience }}+</h2>
              <span>Years Of Experience <br /> in This Field</span>
            </div>
            <!-- Profit Wrap -->
            <div class="profit__wrap" data-parallax='{"x" : 50 }'>
              <div class="thumb">
                <img src="/frontend/assets/img/images/profit_grap.svg" alt="Profit Graph" />
              </div>
              <div class="content">
            ...
            <!-- Shapes -->
            <div class="shape">
              <img src="/frontend/assets/img/images/about_shape01.svg" alt="Shape 1" data-aos="fade-up-right" data-aos-delay="600" />
              <img src="/frontend/assets/img/images/about_shape02.svg" alt="Shape 2" class="alltuchtopdown" />
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="about__content">
            ...
            <div v-if="!props.fulltext" class="about__content-bottom">
              <Link :href="route('home.about')" class="tg-btn">
                Explore Our Company
                <img src="/frontend/assets/img/icons/right_arrow.svg" alt="Arrow Icon" class="injectable" />
              </Link>
            </div>
          </div>
        </div>
...
const featuresList = computed(() => {
  return props.about.features ? props.about.features.split(",").map((item) => item.trim()) : [];
});
...
const truncatedDescription = computed(() => {
  ...
  if (props.about.description.length > textLimit.value) {
    return props.about.description.substring(0, textLimit.value) + (props.fulltext ? " - " : "...");
  }
  return props.about.description;
});

const remainingDescription = computed(() => {
  return props.about.description && props.about.description.length > textLimit.value
